...
for ($ix1 = 0; $ix1 < 10; $ix1 ++) {
    ...
    if ($sql_out = mysqli_query($dbconn, $sql_code)) {
        ...
        if ($qry_approved == 1) {
            echo '<td><center><a href="uren.php?edtweek=' . $qry_jaar . "-W" . $qry_week . '"><img class="button" src="./img/icons/view-48.png" alt="Toon uren van deze week" title="Toon uren van deze week" /></a></center></td>';
        } else {
            echo '<td><center><a href="uren.php?edtweek=' . $qry_jaar . "-W" . $qry_week . '"><img class="button" src="./img/icons/edit-48.png" alt="Toon uren van deze week" title="Toon uren van deze week" /></a></center></td>';
        }
