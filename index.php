...
<div id="main">		
    ...
    for($ix1=0; $ix1<10; $ix1++) {
        ...
        if($sqlOut = mysqli_query($dbconn, $sqlCode)) {
            ...
            if ($qry_terapprovalaangeboden == 1) echo '<td style="text-align:center;"><img class="button" src="./img/buttons/icons8-ok-48.png" alt="1" title="is ter approval aangeboden" /></td>';
            else echo '<td style="text-align:center;"><img class="button" src="./img/buttons/icons8-cancel-48.png" alt="0" title="is nog niet ter approval aangeboden" /></td>';
            if ($qry_approved == 1) echo '<td style="text-align:center;"><img class="button" src="./img/buttons/icons8-ok-48.png" alt="1" title="is approved" /></td>';
            else echo '<td style="text-align:center;"><img class="button" src="./img/buttons/icons8-cancel-48.png" alt="0" title="is nog niet approved" /></td>';
