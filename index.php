			    ...
			    if(mysqli_num_rows($sql_result) > 0) {
			        ...
			        while($row_selecturen = mysqli_fetch_array($sql_result)) {
			            ...
			            echo '<tr class="'.$rowcolor.'">';
			                ...
			                if ($qry_terapprovalaangeboden == 1) echo '<td style="text-align:center;"><img src="./img/buttons/icons8-checked-48.png" alt="1" title="is ter approval aangeboden" /></td>'; 
			                ...
			                if ($qry_approved == 1) echo '<td style="text-align:center;"><img src="./img/buttons/icons8-checked-48.png" alt="1" title="is approved" /></td>';
