...
<form name="systemlog" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
	<p>
	<input class="button" type="submit" name="clean" value="clean log">
	<input class="button" type="submit" name="close" value="close window">
	</p>
</form>