...
function add_row(js_aantal_dagen_readonly) {
	...
	$("#uren_table tr:last").after("" +
		"<tr id='row"+$rowno+"'>" +
			...
			"<td colspan=2><img class='button' src='./img/buttons/icons8-plus-48.png' alt='add rij' title='add rij' onclick=add_row("+js_aantal_dagen_readonly+");> <img class='button' src='./img/buttons/icons8-trash-can-48.png' alt='verwijder rij' title='verwijder rij' onclick=delete_row('row"+$rowno+"')></td>" +
			"<td></td>" +
		"</tr>");
}
