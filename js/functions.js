...
function add_row() {
	...
	$("#uren_table tr:last").after("" +
		"<tr id='row"+$rowno+"'>" +
			...
			"<td><input style='width:3.33vw' type='number' name='dag1[]' min='0' max='24' step='0.25' size='2'></td>" +
			"<td><input style='width:3.33vw' type='number' name='dag2[]' min='0' max='24' step='0.25' size='2'></td>" +
			"<td><input style='width:3.33vw' type='number' name='dag3[]' min='0' max='24' step='0.25' size='2'></td>" +
			"<td><input style='width:3.33vw' type='number' name='dag4[]' min='0' max='24' step='0.25' size='2'></td>" +
