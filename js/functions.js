...
function add_row(js_aantal_dagen_readonly) {
	...
	$("#uren_table tr:last").after("" +
		"<tr id='row"+$rowno+"'>" +
			...
			"<td><input style='width:3.33vw;text-align:right' type='text' name='dag1[]' min='0' max='24' step='0.25' size='2' "+readonly_dag0+"></td>" +
			"<td><input style='width:3.33vw;text-align:right' type='text' name='dag2[]' min='0' max='24' step='0.25' size='2' "+readonly_dag1+"></td>" +
			"<td><input style='width:3.33vw;text-align:right' type='text' name='dag3[]' min='0' max='24' step='0.25' size='2' "+readonly_dag2+"></td>" +
			"<td><input style='width:3.33vw;text-align:right' type='text' name='dag4[]' min='0' max='24' step='0.25' size='2' "+readonly_dag3+"></td>" +
			"<td><input style='width:3.33vw;text-align:right' type='text' name='dag5[]' min='0' max='24' step='0.25' size='2' "+readonly_dag4+"></td>" +
			"<td><input style='width:3.33vw;text-align:right' type='text' name='dag6[]' min='0' max='24' step='0.25' size='2' "+readonly_dag5+"></td>" +
			"<td><input style='width:3.33vw;text-align:right' type='text' name='dag7[]' min='0' max='24' step='0.25' size='2' "+readonly_dag6+"></td>" +
