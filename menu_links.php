...
<div class="sidebox">
	...
	<ul class="sidemenu">
		...
		<li><a
			href="rpt_uren_urensoort.php?username=<?php echo $_SESSION["username_encrypted"] ?>">Mijn
				geboekte uren per maand</a></li>
		<li><a
			href="users.php?aktie=editprof&edtuser=<?php echo $_SESSION["username_encrypted"] ?>">Mijn
				profiel</a></li>
	</ul>
</div>
...
<div class="sidebox">
	...
	<ul class="sidemenu">
		...
		<li><a href="display_systemlog.php" target="_blank">Display systemlog</a></li>
	</ul>
</div>
<div class="sidebox">
	...
	<ul class="sidemenu">
		...
		<li><a href="rpt_verlofuren_medewerker.php">Opgenomen verlofuren per
				mdw</a></li>
	</ul>
</div>
<?php
